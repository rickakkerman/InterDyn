...
"""
Original VideoProcessor implementation from `diffusers.image_processor.VaeImageProcessor`
— except for the channel re-ordering step (originally on line 71) which has been removed.
"""
...
class VideoProcessor(VaeImageProcessor):
    ...
    def preprocess_video(self, video, height: Optional[int] = None, width: Optional[int] = None) -> torch.Tensor:
        ...
        # video = video.permute(0, 2, 1, 3, 4) <---- Removed
